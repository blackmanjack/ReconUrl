  ...
  const htmlContent = `
    ...
    <head>
      ...
      <head>
		...
		<meta charset="utf-8">
<script>window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","errorBeacon":"bam.nr-data.net","licenseKey":"2ff0bc8e20","applicationID":"4115141","transactionName":"c1hbEkVfCgoHQhkPXV1VUBREHxUDEUNfDVZDGFsDQA==","queueTime":1,"applicationTime":31,"agent":""}</script>
<script>(window.NREUM||(NREUM={})).init={ajax:{deny_list:["bam.nr-data.net"]}};(window.NREUM||(NREUM={})).loader_config={xpid:"VgEBWVNWGwcBVVRTAwA=",licenseKey:"2ff0bc8e20",applicationID:"4115141"};;/*! For license information please see nr-loader-full-1.246.1.min.js.LICENSE.txt */
...
<meta name="csrf-token" content="0ndk1rUaKdCp/jCgjKYhDjHONVfGgyFLFsCMSUsYQgNfQoa7qKDFozKGKaCmGHKpDTv6kyL769yUiHyveWtJsg==">
<link rel="shortcut icon" type="image/x-icon" href="https://d1pspl52z5rk07.cloudfront.net/static/favicon.ico">

		<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1.0">
		<title>GrabCAD</title>
<meta name="description" content="The GrabCAD platform drives additive manufacturing at scale through connected solutions, including GrabCAD Print, GrabCAD Shop &amp; the GrabCAD SDKs.">
		
		<link rel="stylesheet" media="screen" href="https://d1pspl52z5rk07.cloudfront.net/assets/production/app/app_community-8ead065412b8c85ce2d982d8bdae6c0f5ab0e93ddac93f037251d600e295e560.css">
		
		<link rel="stylesheet" media="screen" href="https://d1pspl52z5rk07.cloudfront.net/assets/production/app/app_1-d887cacbed735b97dae1ae31fb67920592278b1772b98fc11a6b78a985839de4.css">

		
		<script src="https://d1pspl52z5rk07.cloudfront.net/assets/production/app/modernizr.min-c0c448f456c0b3d4c9bdd265b8dd874015e13877fbba7b777c94c0c1c8f8fcfb.js"></script>
		
		<script async="" src="https://www.googletagmanager.com/gtag/js?id=UA-17245501-6"></script>
<script>
	window.dataLayer = window.dataLayer || [];
	function gtag(){dataLayer.push(arguments);}
	gtag('js', new Date());

	gtag('config', 'UA-17245501-6');
</script>
<style>.async-hide .ab-testable-element { opacity: 0 !important} </style>
<script>(function(a,s,y,n,c,h,i,d,e){s.className+=' '+y;h.start=1*new Date;
	h.end=i=function(){s.className=s.className.replace(RegExp(' ?'+y),'')};
	(a[n]=a[n]||[]).hide=h;setTimeout(function(){i();h.end=null},c);h.timeout=c;
})(window,document.documentElement,'async-hide','dataLayer',4000,
	{'GTM-NXVV8ZB':true});</script>
...
Grabcad.AttributeLimits = {
	...
	Legacy: {
		URL: 255,
		  ...
		  <script id="bizible-settings" type="text/javascript" src="https://cdn.bizible.com/scripts/bizible.js?account=stratasys.com" async="">
  </script>

	<style></style><style type="text/css">.resize-observer[data-v-b329ee4c]{position:absolute;top:0;left:0;z-index:-1;width:100%;height:100%;border:none;background-color:transparent;pointer-events:none;display:block;overflow:hidden;opacity:0}.resize-observer[data-v-b329ee4c] object{display:block;position:absolute;top:0;left:0;height:100%;width:100%;overflow:hidden;pointer-events:none;z-index:-1}</style><meta http-equiv="origin-trial" content=""><style hs-beacon="active" data-styled-version="5.1.1"></style></head>
      <!-- Other HTML elements -->
    </head>
    <body id="members-sessions">
  ...
  <nav class="main">
	...
	<li class="app-selection-menu hover-element">
		<a class="selected-app link-mobile-disabled" href="https://grabcad.com/dashboard">
			...
			<span class="dropdown-icon">
				<svg width="10" height="11" viewBox="0 0 1024 1024">
					<path d="M1025 320q0 -26 -19 -45t-45 -19h-896q-26 0 -45 19t-19 45t19 45l448 448q19 19 45 19t45 -19l448 -448q19 -19 19 -45z" fill="#fff"></path>
				</svg>
			</span>
		</a>
		<ul class="selection lightDropdown">
			...
			<li>
				<a class="text-normal " target="_self" href="/print/account">
...
<input type="checkbox" id="showMenu" role="button">
	<ul class="login-menu">
		<li>
			<a data-toggle="modal" href="/community/login?return=true" class="login" target="_self">
				Log in
			</a>
		</li>
	</ul>
      ...
      <ul class="menu">
		...
		<section id="body" class="">
			<section id="bodyContent" class="gc">
				<div class="g1">
					<div class="flashMessage">
</div>

				</div>
				<script> window.signInModalPermanent = true; </script>
		...
		<div id="dimmer"></div>
<div id="" class="popupWin">
	<div class="contentWrapper">
		<div class="popupHeader">
			<span class="popupName">
				<h2></h2>
				<p></p>
			</span>
		...
		<div class="popupFooter">
			<span class="buttons">
				<span class="button b32 red submit" id="popupSubmit">Save</span>
				<a href="#" class="button cancelButton" id="popupCancel">Cancel</a>
			</span>
		</div>
	</div>
</div>
	  ...
	  <div id="signInModal"><div class="sign-in-modal__wrap sign-in-modal__wrap--permanent"><!----> <div class="sign-in-modal__modal"><div class="sign-in-modal__header"><h4 class="sign-in-modal__title">
              Sign In or Create Account
            </h4> <!----> <!----></div> <div class="sign-in-modal__body"><form method="post" id="login_form" __bizdiag="770083267" __biza="WJ__"><div class="sign-in__input-block"><i class="fas fa-envelope sign-in__input-icon"></i> <input type="email" name="member[email]" placeholder="Enter email" autocomplete="off" class="sign-in__input sign-in__input--email"></div> <div class="sign-in__input-wrap"><div class="sign-in__input-block"><i class="fas fa-lock sign-in__input-icon"></i> <input type="password" placeholder="Enter password" name="member[password]" autocomplete="off" class="sign-in__input sign-in__input--password"> <a href="#" class="sign-in__input--password-visibility"><i class="fas fa-eye"></i></a></div> <a href="#" class="sign-in__forgot-password"><i class="fas fa-question"></i></a></div> <!----> <button type="submit" id="signInButton" class="sign-in__button">Sign In</button></form> <div class="sign-in__social-network-buttons"><form action="/auth/facebook" method="post" __bizdiag="994322731" __biza="WJ__"><input type="hidden" name="authenticity_token" value="0ndk1rUaKdCp/jCgjKYhDjHONVfGgyFLFsCMSUsYQgNfQoa7qKDFozKGKaCmGHKpDTv6kyL769yUiHyveWtJsg=="> <button type="submit" class="sign-in__social-network-button sign-in__social-network-button--facebook"><i class="fab fa-facebook-f"></i></button></form> <form action="/auth/linkedin" method="post" __bizdiag="994322731" __biza="WJ__"><input type="hidden" name="authenticity_token" value="0ndk1rUaKdCp/jCgjKYhDjHONVfGgyFLFsCMSUsYQgNfQoa7qKDFozKGKaCmGHKpDTv6kyL769yUiHyveWtJsg=="> <button type="submit" class="sign-in__social-network-button sign-in__social-network-button--linkedin"><i class="fab fa-linkedin-in"></i></button></form> <form action="/auth/google_oauth2" method="post" __bizdiag="994322731" __biza="WJ__"><input type="hidden" name="authenticity_token" value="0ndk1rUaKdCp/jCgjKYhDjHONVfGgyFLFsCMSUsYQgNfQoa7qKDFozKGKaCmGHKpDTv6kyL769yUiHyveWtJsg=="> <button type="submit" class="sign-in__social-network-button sign-in__social-network-button--google"><i class="fab fa-google"></i></button></form></div> <div><div class="sign-in__or-wrap"><hr class="sign-in__or-hr"> <div class="sign-in__or">or</div> <hr class="sign-in__or-hr"></div> <a href="/profile/register" target="_self" class="sign-in__button">
										Create Account
    ...
    <div class="gc_web_layout-wrapper gc_web_comp-footer__wrapper">
        <div class="gc_web_layout-container">
                ...
                <div class="gc_web_comp-footer__sections">
                        ...
                        <div class="gc_web_comp-footer__section">
                            ...
                            <div class="gc_web_comp-footer__section-links">
                                    ...
                                    <div>
                                        <a target="_blank" rel="noopener noreferrer" href="https://help.grabcad.com">Help Center</a>
                                    </div>
                            </div>
                        </div>
                        <div class="gc_web_comp-footer__section">
                        ...
                        <div class="gc_web_comp-footer__section">
                            ...
                            <div class="gc_web_comp-footer__section-links">
                                    ...
                                    <div>
                                        <a target="_self" href="https://grabcad.com/print/polyjet">Advanced PolyJet</a>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        <a target="_self" href="https://grabcad.com/print/p3">Origin One</a>
                                    </div>
                            </div>
                        </div>
                        <div class="gc_web_comp-footer__section">
                            ...
                            <div class="gc_web_comp-footer__section-links">
                                    ...
                                    <div>
                                        <a target="_self" href="https://grabcad.com/shop/pricing">Pricing</a>
                                    </div>
                            </div>
                        </div>
                        <div class="gc_web_comp-footer__section">
            ...
            <div class="gc_web_comp-footer__bottomlinks">
                ...
                <a target="_blank" rel="noopener" href="https://help.grabcad.com/article/232-your-data-on-grabcad">Your Data on GrabCAD</a>
            </div>
		...
		<script src="https://d1pspl52z5rk07.cloudfront.net/assets/production/app/application-27694a080bf5562ea10dbf9fa5c0bd5d03b111301ca3d71d0c5bae52a2228d10.js"></script>
		<script type="text/javascript">
            Grabcad.configuration.configure({
  imagePath: 'https://d1pspl52z5rk07.cloudfront.net/images',
  default3dModelPath: '/static/content/cube_holes_5.STL',
  maximumCategoriesOnCadfile: 3,
  uploadPath: 'https://s3.amazonaws.com/gc-p',
  uploadifyFlash: 'https://d1pspl52z5rk07.cloudfront.net/flash/uploadify.swf',
  uploadFileSizeLimit: 524288000,
  recaptchaKey: '6LdkkBkUAAAAAOpZhSajb_PoE1sw3mORcZhLNkKe',
  airbrake_options: {
    project_key: 'bced41dc67ce770c9d55b39f172f1a47',
    production: true,
...
$.ajax({
	...
	success: function() {
		...
		<div class="feedbackContainer mobileFeedback">
	...
	<noscript>
		...
		<script src="https://d1pspl52z5rk07.cloudfront.net/assets/production/app/application_frontend/app-c94584167bebd6ae46611450d7a3252c34deecbc428a08e918145c7ca74bf3e2.js"></script>
  

<img alt="" src="https://cdn.bizible.com/ipv?_biz_r=&amp;_biz_h=1304793173&amp;_biz_u=265b476fdc9c492ea679b21bfaf32073&amp;_biz_s=170746&amp;_biz_l=https%3A%2F%2Fgrabcad.com%2Flogin&amp;_biz_t=1699099476636&amp;_biz_i=GrabCAD&amp;_biz_n=80&amp;a=stratasys.com&amp;rnd=20371&amp;cdn_o=a&amp;_biz_z=1699099476662" style="display: none;"><div id="beacon-container"><div class="hsds-beacon"><div class="Beacon"><div class="ContainerGradient-sc-62zoy-0 dkxqZi"></div><div class="ContainerFramecss__WrapperUI-sc-d7rzhh-0 itSWDc BeaconContainer is-configDisplayRight is-mobile"><button data-cy="beacon-close-button" class="CloseButtoncss__ButtonUI-sc-1phd8sn-1 jwGyQJ c-BeaconCloseButton is-mobile is-rendered"><div class="CloseButtoncss__ButtonContentUI-sc-1phd8sn-0 TSYHV"><span class="CloseButtoncss__LabelUI-sc-1phd8sn-2 hVAllm c-BeaconCloseButton__label"><span data-cy="Text" class="Textstyles__TextUI-sc-jkyxsz-0 frCWgc c-Text is-span is-13 is-default">Close</span></span><span aria-hidden="true" role="img" data-cy="Icon" class="Iconstyles__IconUI-sc-35yr6s-0 bGxvTN c-Icon is-noInteract is-iconName-cross-small is-24 c-BeaconCloseButton__iconClose" data-icon-name="cross-small" title="cross-small"><span class="c-Icon__icon"><span data-cy="BaseIcon" class="baseIcon__BaseIconUI-sc-q7zmye-0 izECQ"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M13.414 12l2.293-2.293a.999.999 0 1 0-1.414-1.414L12 10.586 9.707 8.293a.999.999 0 1 0-1.414 1.414L10.586 12l-2.293 2.293a.999.999 0 1 0 1.414 1.414L12 13.414l2.293 2.293a.997.997 0 0 0 1.414 0 .999.999 0 0 0 0-1.414L13.414 12z"></path></svg></span></span><span data-cy="VisuallyHidden" class="VisuallyHiddenstyles__VisuallyHiddenUI-sc-15ba650-0 bxIaSx c-VisuallyHidden">cross-small</span></span></div></button></div><div class="FabButtonFramecss__FabButtonFrameUI-sc-y1b4md-0 cYuRIM BeaconFabButtonFrame" style="border-radius: 60px; height: 60px; position: fixed; transform: scale(1); width: 60px; z-index: 1049;"><iframe title="Help Scout Beacon - Open" id="" allowtransparency="true" data-cy="FrameComponent"></iframe></div></div></div></div></body>
    </html>
  `;
